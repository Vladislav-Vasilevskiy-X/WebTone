...
{
	/// <summary>
	///     Decorator for <see cref="IWebDriver" /> that contains overriden FindElement, FindElements methods that use
	///     <see cref="AjaxElementLocator" />
	/// </summary>
	public class AjaxWebDriver : IWebDriver, IHasInputDevices, IJavaScriptExecutor, ITakesScreenshot
	{
		...
		/// <summary>
		///     Gets the original driver that holds original FindElement, FindElements methods without
		///     <see cref="AjaxElementLocator" /> procesing.
		/// </summary>
		/// <value>
		///     The original driver.
		/// </value>
		...
		{
			get { return ((IHasInputDevices) OriginalDriver).Keyboard; }
		}
		...
		public IMouse Mouse
		{
			get { return ((IHasInputDevices) OriginalDriver).Mouse; }
		}
		...
		{
			return ((IJavaScriptExecutor) OriginalDriver).ExecuteScript(script, args);
		}
		...
		{
			return ((IJavaScriptExecutor) OriginalDriver).ExecuteAsyncScript(script, args);
		}
		...
		{
			return ((ITakesScreenshot) OriginalDriver).GetScreenshot();
		}
		...
		/// </summary>
		/// <remarks>
		///     Setting the <see cref="P:OpenQA.Selenium.IWebDriver.Url" /> property will load a new web page in the current
		///     browser window.
		...
		public string Url
		{
			get { return OriginalDriver.Url; }

			set { OriginalDriver.Url = value; }
		}
		...
		public string Title
		{
			get { return OriginalDriver.Title; }
		}
		...
		{
			get { return OriginalDriver.PageSource; }
		}
		...
		{
			get { return OriginalDriver.CurrentWindowHandle; }
		}
		...
		{
			get { return OriginalDriver.WindowHandles; }
		}
