...
namespace Container
{
	...
	public static class Logger
	{
		...
		private static readonly Dictionary<string, List<string>> testToLogDictionary = new Dictionary<string, List<string>> { { NoTestContextToLog, new List<string>() } };
		...
		private static void PrintTestResults(bool testPassed = true)
		{
			...
			lock (locker)
			{
				...
				using (var outfile = new StreamWriter(logPath, true))
				{
					...
					VerifyContext.Current.IsTrue(testToLogDictionary.TryGetValue(NoTestContextToLog, out thereIsNoTestLogList), "There are no missed test logs connected to tests");
					...
					List<string> testLog;
					VerifyContext.Current.IsTrue(testToLogDictionary.TryGetValue(FullTestName, out testLog), "No Log for test " + FullTestName);
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "Container.Logger.AddToTestToLogDictionary(System.String)")]
		public static void LogAPIRespond(string content, HttpStatusCode statusCode)
		{
			...
			var message = string.Format(CultureInfo.CurrentCulture, "\nResponse:{3}\n\tStatus code: {0}-{1}\r\n\tResponse content: {2}", (int)statusCode, statusCode, string.IsNullOrWhiteSpace(content) ? "#empty#" : MSTestReportUtils.ReplaceBrackets(content), DateTime.Now.ToString("G", CultureInfo.InvariantCulture));
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "Container.Logger.WriteLine(System.String)")]
		...
		public static void Verify(List<UnitTestVerifyException> assertFailures)
		{
			...
			assertFailures.Select(ex => ex.Message).ForEach(m => formattedTestFailures.AppendLine(m.ReplaceFirst("Assert", "Verify")));
